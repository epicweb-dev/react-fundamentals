...
but rest assured, it's just calling
`ReactDOM.createRoot(rootElement).render(element)` under the hood, just like we
were doing in the previous exercises.
