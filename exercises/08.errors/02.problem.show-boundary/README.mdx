...
form, you'll notice in the console that there's an error (_someone made a typo something like_
😅).
...
something like this happens (_right now, they don't know it's not working and
that's terribly annoying_). So what I want you to do is wrap that callback in our
