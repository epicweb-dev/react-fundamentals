...
The extra credit helps you learn how to create all the documents' elements with JS instead of starting with html. Always remember to append the new elements that you've created. 
