...
Keeping in mind some of the syntax changes from java, some of the funtions to
set do not require the () and will run if present.

Using the append function to set the tag in the body of the HTML

Setting the script type to module

Setting the id and the idName withint the parameters of the element.setAtrributes
first parameter the attribute name and second parameter the value.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=01%3A%20Basic%20JavaScript-rendered%20Hello%20World&em=ramirez.stefano%40gmail.com).
