...
```js
element.className = 'exampleClass'; 
//will actually scrap any existing classes on that element and replace with exampleClass whereas

element.classList.(add/remove/toggle etc)('exampleClass');
//is more targeted and only acts on the class specified (without scrapping any of the others)
```
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=01%3A%20Basic%20JavaScript-rendered%20Hello%20World&em=catecodes%40gmail.com).
