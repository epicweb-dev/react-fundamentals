...
React is the same as document.createElement() and ReactDOM is the same as
rootElement.append()

So it is the same DOM manipulation via JS under the hood except it is using the React and
ReactDOM libraries as a wrapper.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=devneill%40hey.com).
