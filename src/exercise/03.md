...
Using JSX which is not javascript yet there is a api BABEL that compiles the code on 
run time.

changing the script type= 'type/babel' so that babel can compile this script.

slight syntax changes from JSX to HTML look at https://unpkg.com/@babel/standalone@7.12.4/babel.js for reference.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=ramirez.stefano%40gmail.com).
