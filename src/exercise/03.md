...
JSX is another layer of abstraction around the React and ReactDOM libraries. So
JSX is compiled into JS that uses the React and ReactDOM libraries, which is a
wrapper around standard JS DOM manipulation, which creates our HTML.

We can pass children as a prop instead of inside the JSX tags!
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=03%3A%20Using%20JSX&em=devneill%40hey.com).
