...
For function making use the following syntax in JS

function foo ({bar}){
   return x
}

rememeber the JAX syntax to get an element,

e.g. <div className='message'>{children}</div>
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=04%3A%20Creating%20custom%20components&em=ramirez.stefano%40gmail.com).
