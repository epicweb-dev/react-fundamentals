...
The use of the key for an array is important in React as to not loose the referece to the previous or 
following item.
Helps to keep track of elements that React can mess up , this having a key prop for every element and every indexed element helps React keep track.

removing a component in react calls the resource cleanup once the element has been removed from the DOM
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=07%3A%20Rendering%20Arrays&em=ramirez.stefano%40gmail.com).
