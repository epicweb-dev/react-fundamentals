...
[react-dom](https://npm.im/react-dom)). But for these first exercises, we have
the files already downloaded and you can reference them directly without having
to bother installing them. So in the exercise you'll be required to add script
